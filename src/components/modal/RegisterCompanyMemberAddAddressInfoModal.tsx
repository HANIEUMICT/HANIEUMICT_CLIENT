...
interface RegisterCompanyMemberAddAddressInfoModalProps {
  tempAddressData: AddressRegisterRequestType
  setTempAddressData: Dispatch<SetStateAction<AddressRegisterRequestType>>
}

export default function RegisterCompanyMemberAddAddressInfoModal({
  tempAddressData,
  setTempAddressData,
}: RegisterCompanyMemberAddAddressInfoModalProps) {
