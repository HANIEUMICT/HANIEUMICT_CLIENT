...
import { patchMemberMeEmailMarketingConsent, patchMemberMeSMSMarketingConsent } from '@/lib/mypage'
...
interface MyPageBasicInfoProps {
  userInfo: MemberInfoType | undefined
}

export default function MyPageBasicInfo({ userInfo }: MyPageBasicInfoProps) {
    ...
    <section className="p-s border-gray-20 flex flex-col gap-y-[5xs] rounded-[24px] border bg-white">
      ...
      <section className="py-xs border-gray-20 flex flex-col gap-y-[12px] border-b">
        ...
        <ul className="gap-y-4xs flex flex-col">
          <ol className="button-sm text-gray-40">CONIC 및 제휴사의 소식·혜택·이벤트·광고 정보를 받으실 수 있습니다.</ol>
