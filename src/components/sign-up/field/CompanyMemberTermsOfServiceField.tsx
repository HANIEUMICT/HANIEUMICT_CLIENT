import { CheckboxFillIcon, GrayRightArrowIcon, LogoIcon } from '@/assets/svgComponents'
import { useAuthStore } from '@/store/authStore'

export default function CompanyMemberTermsOfServiceField() {
  ...
  return (
    <div className="p-3xs flex w-full items-center justify-between rounded-[12px] bg-white">
      <section className="flex items-center gap-x-2">
        {companySignUpData?.termsOfServiceAgreed ? (
          <CheckboxFillIcon
            onClick={() => {
              setState({
                ...companySignUpData,
                companySignUpData: {
                  ...companySignUpData,
                  termsOfServiceAgreed: !companySignUpData?.termsOfServiceAgreed,
                },
              })
            }}
            width={24}
